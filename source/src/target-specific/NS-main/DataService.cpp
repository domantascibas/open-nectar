...
float TemperatureData::getTemperature(void) {
  if(deviceOpMode_isConfigured()) return espData.temperature;
  else {
...
float TemperatureData::getMaxTemperature(void) {
  if(deviceOpMode_isConfigured()) return espData.temperature_max;
